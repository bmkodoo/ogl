...
/**
 * @author Thongvan Alexis
 * date:    25-FEV-2013
 *
 * I don't take credit for anything, those tutorial are from nehe.
 *
 * But it's 2013 and some stuff don't work anymore so I converted them
 * to lwgjl 2.8.5 and I'm using slick.opengl.TextureLoader instead of devil.IL to load texture
 * (since devil.IL does not exist anymore)
 *
 * Plus if you get this from github it's in a nice maven project which will download
 * for you lwgjl and slick and package everything, plug and play baby.
 *
 * this code is CPU-dependant, meaning :
 * if you have a slow pc the animation will be slow
 * if you have the same pc than me the animation will run at normal speed
 * if you have a faster pc than me the animation will run faster
 *
 * Video tutorial explaining how to set up maven, eclipse, etc : <Not available yet>
 */
...
public class Tut18 {
    ...
    private void init() throws Exception {
        ...
        texture[0] =TextureLoader.getTexture("BMP", ResourceLoader.getResourceAsStream("src/textures/Wall.bmp"));
